...
async def _generate_and_send_report(
    ...
    **kwargs
    ...
    try:
        ...
        # Зберігаємо файл
        file_path = await loop.run_in_executor(None, save_dataframe_to_excel, df, file_prefix)
